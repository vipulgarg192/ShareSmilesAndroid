...
//        this.setOrientation(VERTICAL);
        ...
        views = new LinearLayoutCompat(context);
        views.setOrientation(LinearLayoutCompat.VERTICAL);
        this.addView(views);
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            LinearLayoutCompat.LayoutParams lp = (LinearLayoutCompat.LayoutParams) this.getLayoutParams();
            this.setLayoutParams(new LinearLayoutCompat.LayoutParams(lp.width, itemHeight * displayItemCount));
        }
        return tv;
    }
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.md_red_300));
            } else {
                itemView.setTextColor(getResources().getColor(R.color.md_red_300));
            }
        }
